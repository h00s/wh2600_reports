class Event < ActiveRecord::Base
  ...
  validates :pressure_absolute, numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 1100 }
  validates :pressure_relative, numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 1100 }
